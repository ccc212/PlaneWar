...
class Bullet(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # 子弹四个方向(上下左右)
        self.bullets = [
            'Tank_War/images/bullet/bullet_up.png', 'Tank_War/images/bullet/bullet_down.png',
            'Tank_War/images/bullet/bullet_left.png', 'Tank_War/images/bullet/bullet_right.png'
        ]
        # 子弹方向(默认向上)
    ...
    def move(self):
        ...
        if (self.rect.top < 3) or (self.rect.bottom > 630 - 3) or (
                self.rect.left < 3) or (self.rect.right > 630 - 3):
            self.live = False
